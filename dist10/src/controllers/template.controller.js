...
__decorate([
    ...
    __metadata("design:paramtypes", [models_1.Template]),
...
__decorate([
    ...
    __param(0, rest_1.requestBody()),
    __param(1, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Template))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Template, Object]),
    __metadata("design:returntype", Promise)
], TemplateController.prototype, "updateAll", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, models_1.Template]),
    __metadata("design:returntype", Promise)
], TemplateController.prototype, "updateById", null);
__decorate([
    rest_1.del('/Templates/{id}', {
        responses: {
            '204': {
...
TemplateController = __decorate([
    ...
    __metadata("design:paramtypes", [repositories_1.TemplateRepository])
], TemplateController);
