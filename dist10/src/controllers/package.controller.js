...
let PackageController = class PackageController {
    ...
    async updateAll(packages, where) {
...
__decorate([
    ...
    __param(0, rest_1.requestBody()),
    __param(1, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Package))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Package, Object]),
    __metadata("design:returntype", Promise)
], PackageController.prototype, "updateAll", null);
__decorate([
...
PackageController = __decorate([
    ...
    __metadata("design:paramtypes", [repositories_1.PackageRepository])
], PackageController);
