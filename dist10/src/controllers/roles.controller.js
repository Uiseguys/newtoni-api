    ...
    rest_1.post('/roles', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: { 'x-ts-type': models_1.Roles } } },
            },
        },
    }),
    __param(0, rest_1.requestBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Roles]),
...
__decorate([
    ...
    __param(0, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Roles))),
    __metadata("design:type", Function),
    ...
    rest_1.get('/roles', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: { type: 'array', items: { 'x-ts-type': models_1.Roles } },
                    },
                },
            },
        },
    }),
    __param(0, rest_1.param.query.object('filter', rest_1.getFilterSchemaFor(models_1.Roles))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, rest_1.requestBody()),
    __param(1, rest_1.param.query.object('where', rest_1.getWhereSchemaFor(models_1.Roles))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [models_1.Roles, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, models_1.Roles]),
    __metadata("design:returntype", Promise)
...
RolesController = __decorate([
    __param(0, repository_1.repository(repositories_1.RolesRepository)),
    __metadata("design:paramtypes", [repositories_1.RolesRepository])
], RolesController);
